#undef INHERITENCEEXP_API
#undef INHERITENCEEXP_VTABLE
...
#define UE_PROJECT_NAME InheritenceExp
...
#define INHERITENCEEXP_VTABLE DLLEXPORT_VTABLE
#define INHERITENCEEXP_API DLLEXPORT
