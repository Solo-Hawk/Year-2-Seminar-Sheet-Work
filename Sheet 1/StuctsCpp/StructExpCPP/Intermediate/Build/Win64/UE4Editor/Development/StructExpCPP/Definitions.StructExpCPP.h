#undef STRUCTEXPCPP_API
#undef STRUCTEXPCPP_VTABLE
...
#define UE_PROJECT_NAME StructExpCPP
...
#define STRUCTEXPCPP_VTABLE DLLEXPORT_VTABLE
#define STRUCTEXPCPP_API DLLEXPORT
