#undef STRUCTCPPEXP_API
#undef STRUCTCPPEXP_VTABLE
...
#define UE_PROJECT_NAME StructCppExp
...
#define STRUCTCPPEXP_VTABLE DLLEXPORT_VTABLE
#define STRUCTCPPEXP_API DLLEXPORT
