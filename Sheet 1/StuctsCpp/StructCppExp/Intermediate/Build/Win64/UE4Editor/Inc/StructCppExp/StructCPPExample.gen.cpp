...
#include "StructCppExp/StructCPPExample.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeStructCPPExample() {}
// Cross Module References
	STRUCTCPPEXP_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponStruct();
	UPackage* Z_Construct_UPackage__Script_StructCppExp();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FTableRowBase();
	STRUCTCPPEXP_API UScriptStruct* Z_Construct_UScriptStruct_FContainerStruct();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	STRUCTCPPEXP_API UScriptStruct* Z_Construct_UScriptStruct_FCharacterStruct();
	STRUCTCPPEXP_API UClass* Z_Construct_UClass_UStructCPPExample_NoRegister();
	STRUCTCPPEXP_API UClass* Z_Construct_UClass_UStructCPPExample();
...
class UScriptStruct* FWeaponStruct::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern STRUCTCPPEXP_API uint32 Get_Z_Construct_UScriptStruct_FWeaponStruct_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponStruct, Z_Construct_UPackage__Script_StructCppExp(), TEXT("WeaponStruct"), sizeof(FWeaponStruct), Get_Z_Construct_UScriptStruct_FWeaponStruct_Hash());
	}
	return Singleton;
}
template<> STRUCTCPPEXP_API UScriptStruct* StaticStruct<FWeaponStruct>()
{
	return FWeaponStruct::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FWeaponStruct(FWeaponStruct::StaticStruct, TEXT("/Script/StructCppExp"), TEXT("WeaponStruct"), false, nullptr, nullptr);
static struct FScriptStruct_StructCppExp_StaticRegisterNativesFWeaponStruct
{
	FScriptStruct_StructCppExp_StaticRegisterNativesFWeaponStruct()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("WeaponStruct")),new UScriptStruct::TCppStructOps<FWeaponStruct>);
	}
} ScriptStruct_StructCppExp_StaticRegisterNativesFWeaponStruct;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FWeaponStruct_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "StructCPPExample.h" },
	};
#endif
	...
	UScriptStruct* Z_Construct_UScriptStruct_FWeaponStruct()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_StructCppExp();
	...
	uint32 Get_Z_Construct_UScriptStruct_FWeaponStruct_Hash() { return 2681317357U; }
class UScriptStruct* FContainerStruct::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern STRUCTCPPEXP_API uint32 Get_Z_Construct_UScriptStruct_FContainerStruct_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FContainerStruct, Z_Construct_UPackage__Script_StructCppExp(), TEXT("ContainerStruct"), sizeof(FContainerStruct), Get_Z_Construct_UScriptStruct_FContainerStruct_Hash());
	}
	return Singleton;
}
template<> STRUCTCPPEXP_API UScriptStruct* StaticStruct<FContainerStruct>()
{
	return FContainerStruct::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FContainerStruct(FContainerStruct::StaticStruct, TEXT("/Script/StructCppExp"), TEXT("ContainerStruct"), false, nullptr, nullptr);
static struct FScriptStruct_StructCppExp_StaticRegisterNativesFContainerStruct
{
	FScriptStruct_StructCppExp_StaticRegisterNativesFContainerStruct()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("ContainerStruct")),new UScriptStruct::TCppStructOps<FContainerStruct>);
	}
} ScriptStruct_StructCppExp_StaticRegisterNativesFContainerStruct;
	...
	uint32 Get_Z_Construct_UScriptStruct_FContainerStruct_Hash() { return 1853354284U; }
class UScriptStruct* FCharacterStruct::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern STRUCTCPPEXP_API uint32 Get_Z_Construct_UScriptStruct_FCharacterStruct_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterStruct, Z_Construct_UPackage__Script_StructCppExp(), TEXT("CharacterStruct"), sizeof(FCharacterStruct), Get_Z_Construct_UScriptStruct_FCharacterStruct_Hash());
	}
	return Singleton;
}
template<> STRUCTCPPEXP_API UScriptStruct* StaticStruct<FCharacterStruct>()
{
	return FCharacterStruct::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCharacterStruct(FCharacterStruct::StaticStruct, TEXT("/Script/StructCppExp"), TEXT("CharacterStruct"), false, nullptr, nullptr);
static struct FScriptStruct_StructCppExp_StaticRegisterNativesFCharacterStruct
{
	FScriptStruct_StructCppExp_StaticRegisterNativesFCharacterStruct()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CharacterStruct")),new UScriptStruct::TCppStructOps<FCharacterStruct>);
	}
} ScriptStruct_StructCppExp_StaticRegisterNativesFCharacterStruct;
	...
	uint32 Get_Z_Construct_UScriptStruct_FCharacterStruct_Hash() { return 604510719U; }
	void UStructCPPExample::StaticRegisterNativesUStructCPPExample()
	{
	}
	UClass* Z_Construct_UClass_UStructCPPExample_NoRegister()
	{
		return UStructCPPExample::StaticClass();
	}
	struct Z_Construct_UClass_UStructCPPExample_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UStructCPPExample_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UObject,
		(UObject* (*)())Z_Construct_UPackage__Script_StructCppExp,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStructCPPExample_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "StructCPPExample.h" },
		{ "ModuleRelativePath", "StructCPPExample.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UStructCPPExample_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UStructCPPExample>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UStructCPPExample_Statics::ClassParams = {
		&UStructCPPExample::StaticClass,
		nullptr,
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UStructCPPExample_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UStructCPPExample_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UStructCPPExample()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UStructCPPExample_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UStructCPPExample, 2722588359);
	template<> STRUCTCPPEXP_API UClass* StaticClass<UStructCPPExample>()
	{
		return UStructCPPExample::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UStructCPPExample(Z_Construct_UClass_UStructCPPExample, &UStructCPPExample::StaticClass, TEXT("/Script/StructCppExp"), TEXT("UStructCPPExample"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UStructCPPExample);
